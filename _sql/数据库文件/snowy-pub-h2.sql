...
CREATE TABLE `sys_app`  (
  ...
  `active` varchar(1) NULL DEFAULT NULL COMMENT '是否默认激活（Y-是，N-否）',
...
CREATE TABLE `sys_area`  (
  ...
  `level_code` tinyint(0) COMMENT '层级',
...
CREATE UNIQUE INDEX `uk_code` ON `sys_area` (`area_code`);
CREATE INDEX `idx_parent_code` ON `sys_area` (`parent_code`);
...
CREATE TABLE `sys_code_generate`  (
  ...
  `package_name` varchar(255) NULL DEFAULT NULL COMMENT '包名称',
  `bus_name` varchar(255) NULL DEFAULT NULL COMMENT '业务名',
  `table_comment` varchar(255) NULL DEFAULT NULL COMMENT '功能名',
...
CREATE TABLE `sys_code_generate_config`  (
  ...
  `column_name` varchar(255) NULL DEFAULT NULL COMMENT '数据库字段名',
  `java_name` varchar(255) NULL DEFAULT NULL COMMENT 'java类字段名',
  `data_type` varchar(255) NULL DEFAULT NULL COMMENT '物理类型',
  `column_comment` varchar(255) NULL DEFAULT NULL COMMENT '字段描述',
  `java_type` varchar(255) NULL DEFAULT NULL COMMENT 'java类型',
  `effect_type` varchar(255) NULL DEFAULT NULL COMMENT '作用类型（字典）',
  `dict_type_code` varchar(255) NULL DEFAULT NULL COMMENT '字典code',
  `whether_table` varchar(255) NULL DEFAULT NULL COMMENT '列表展示',
  `whether_add_update` varchar(255) NULL DEFAULT NULL COMMENT '增改',
  `whether_retract` varchar(255) NULL DEFAULT NULL COMMENT '列表是否缩进（字典）',
  `whether_required` varchar(255) NULL DEFAULT NULL COMMENT '是否必填（字典）',
  `query_whether` varchar(255) NULL DEFAULT NULL COMMENT '是否是查询条件',
  `query_type` varchar(255) NULL DEFAULT NULL COMMENT '查询方式',
  `column_key` varchar(255) NULL DEFAULT NULL COMMENT '主键',
  `column_key_name` varchar(255) NULL DEFAULT NULL COMMENT '主外键名称',
  `whether_common` varchar(255) NULL DEFAULT NULL COMMENT '是否是通用字段',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `create_user` bigint(0) NULL DEFAULT NULL COMMENT '创建人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  `update_user` bigint(0) NULL DEFAULT NULL COMMENT '修改人',
...
CREATE TABLE `sys_emp`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
  `job_num` varchar(100) NULL DEFAULT NULL COMMENT '工号',
...
CREATE TABLE `sys_file_info`  (
  ...
  `file_bucket` varchar(1000) NULL DEFAULT NULL COMMENT '文件仓库',
  `file_origin_name` varchar(100) NOT NULL COMMENT '文件名称（上传时候的文件名）',
  `file_suffix` varchar(50) NULL DEFAULT NULL COMMENT '文件后缀',
  `file_size_kb` bigint(0) NULL DEFAULT NULL COMMENT '文件大小kb',
  `file_size_info` varchar(100) NULL DEFAULT NULL COMMENT '文件大小信息，计算后的',
  `file_object_name` varchar(100) NOT NULL COMMENT '存储到bucket的名称（文件唯一标识id）',
  `file_path` varchar(1000) NULL DEFAULT NULL COMMENT '存储路径',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `sys_menu`  (
  ...
  `router` varchar(255) NULL DEFAULT NULL COMMENT '路由地址',
  `component` varchar(255) NULL DEFAULT NULL COMMENT '组件地址',
...
CREATE TABLE `sys_notice`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
  `title` varchar(1000) NULL DEFAULT NULL COMMENT '标题',
  ...
  `public_org_name` varchar(50) NULL DEFAULT NULL COMMENT '发布机构名称',
...
CREATE TABLE `sys_oauth_user`  (
  ...
  `access_token` varchar(255) NULL DEFAULT NULL COMMENT '用户授权的token',
  ...
  `company` varchar(255) NULL DEFAULT NULL COMMENT '所在公司',
  `location` varchar(255) NULL DEFAULT NULL COMMENT '位置',
  `email` varchar(255) NULL DEFAULT NULL COMMENT '邮箱',
  `gender` varchar(50) NULL DEFAULT NULL COMMENT '性别',
  `source` varchar(255) NULL DEFAULT NULL COMMENT '用户来源',
  `remark` varchar(255) NULL DEFAULT NULL COMMENT '用户备注（各平台中的用户个人介绍）',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `create_user` bigint(0) NULL DEFAULT NULL COMMENT '创建用户',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `sys_op_log`  (
  ...
  `success` char(1) NULL DEFAULT NULL COMMENT '是否执行成功（Y-是，N-否）',
  ...
  `url` varchar(500) NULL DEFAULT NULL COMMENT '请求地址',
  `class_name` varchar(500) NULL DEFAULT NULL COMMENT '类名称',
  `method_name` varchar(500) NULL DEFAULT NULL COMMENT '方法名称',
  `req_method` varchar(255) NULL DEFAULT NULL COMMENT '请求方式（GET POST PUT DELETE)',
  `param` text NULL COMMENT '请求参数',
  `result` longtext NULL COMMENT '返回结果',
  `op_time` datetime(0) NULL DEFAULT NULL COMMENT '操作时间',
  `account` varchar(50) NULL DEFAULT NULL COMMENT '操作账号',
  PRIMARY KEY (`id`)
);
...
CREATE UNIQUE INDEX `CODE_UNI` ON `sys_pos` (`code`);
...
CREATE TABLE `sys_sms`  (
  ...
  `validate_code` varchar(255) NULL DEFAULT NULL COMMENT '短信验证码',
  `template_code` varchar(255) NULL DEFAULT NULL COMMENT '短信模板ID',
  `biz_id` varchar(255) NULL DEFAULT NULL COMMENT '回执id，可根据该id查询具体的发送状态',
...
CREATE TABLE `sys_timers`  (
  ...
  `timer_name` varchar(255) NULL DEFAULT '' COMMENT '任务名称',
  `action_class` varchar(255) NULL DEFAULT NULL COMMENT '执行任务的class的类名（实现了TimerTaskRunner接口的类的全称）',
...
CREATE TABLE `sys_user`  (
  ...
  `last_login_ip` varchar(100) NULL DEFAULT NULL COMMENT '最后登陆IP',
...
CREATE TABLE `sys_vis_log`  (
  ...
  `account` varchar(50) NULL DEFAULT NULL COMMENT '访问账号',
  PRIMARY KEY (`id`)
);
