		...
		>
			<a-row :gutter="8">
				<a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<a-form-item label="是否允许企业微信登录：" name="SNOWY_THIRD_WORKWECHAT_ALLOW_LOGIN_FLAG">
						<a-switch
							v-model:checked="formData.SNOWY_THIRD_WORKWECHAT_ALLOW_LOGIN_FLAG"
							checked-children="是"
							un-checked-children="否"
							placeholder="请选择是否允许企业微信登录"
						/>
					</a-form-item>
				</a-col>
				<a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
				...
				<a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					...
					>
						...
						<a-input v-model:value="formData.SNOWY_THIRD_WORKWECHAT_REDIRECT_URL" placeholder="请输入重定向地址" />
					</a-form-item>
				</a-col>
				<a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<a-form-item>
...
<script setup name="workWechatThirdForm">
	...
	const formRules = {
		// 是否允许企业微信登录
		SNOWY_THIRD_WORKWECHAT_ALLOW_LOGIN_FLAG: [required('请选择是否允许企业微信登录')],
		SNOWY_THIRD_WORKWECHAT_AGENT_ID: [required('请输入agentId')],
		SNOWY_THIRD_WORKWECHAT_CLIENT_ID: [required('请输入clientId')],
		SNOWY_THIRD_WORKWECHAT_CLIENT_SECRET: [required('请输入clientSecret')],
		SNOWY_THIRD_WORKWECHAT_REDIRECT_URL: [required('请输入重定向地址')]
	}
	// 验证并提交数据
	const onSubmit = () => {
		formRef.value
