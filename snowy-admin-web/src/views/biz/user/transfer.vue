...
<script setup>
	...
	import bizTransferApi from '@/api/biz/bizTransferApi'
	...
	const selectorApiFunction = {
		orgTreeApi: (param) => {
			return bizTransferApi.transferOrgTreeSelector(param).then((data) => {
				return Promise.resolve(data)
			})
		},
		userPageApi: (param) => {
			return bizTransferApi.transferUserSelector(param).then((data) => {
				return Promise.resolve(data)
			})
		}
	}
	...
	const loadResourceList = () => {
		...
		selectedResourceMap.value = {}
		bizTransferApi.transferResourceList({ sourceUserId: sourceUser.value.id }).then((data) => {
