...
INSERT INTO `DEV_CONFIG` VALUES ('1908870094824755301', 'SNOWY_FILE_RUSTFS_ACCESS_KEY', 'RUSTFS文件AccesKey', 'FILE_RUSTFS', 'RUSTFS文件AccesKey', 184, NULL, 'NOT_DELETE', NULL, NULL, NULL, NULL);
INSERT INTO `DEV_CONFIG` VALUES ('1908870094824755302', 'SNOWY_FILE_RUSTFS_SECRET_KEY', 'RUSTFS文件SecetKey', 'FILE_RUSTFS', 'RUSTFS文件SecetKey', 185, NULL, 'NOT_DELETE', NULL, NULL, NULL, NULL);
INSERT INTO `DEV_CONFIG` VALUES ('1908870094824755303', 'SNOWY_FILE_RUSTFS_END_POINT', 'RUSTFS文件EndPoint', 'FILE_RUSTFS', 'RUSTFS文件EndPoint', 186, NULL, 'NOT_DELETE', NULL, NULL, NULL, NULL);
INSERT INTO `DEV_CONFIG` VALUES ('1908870094824755304', 'SNOWY_FILE_RUSTFS_DEFAULT_BUCKET_NAME', 'defaultbucket', 'FILE_RUSTFS', 'RUSTFS文件默认存储桶', 187, NULL, 'NOT_DELETE', NULL, NULL, NULL, NULL);
INSERT INTO `DEV_CONFIG` VALUES ('1908870094824755305', 'SNOWY_FILE_RUSTFS_REGION', 'us-east-1', 'FILE_RUSTFS', 'RUSTFS文件区域', 188, NULL, 'NOT_DELETE', NULL, NULL, NULL, NULL);
...
INSERT INTO `SYS_RESOURCE` VALUES ('1548901111999772826', '1548901111999772126', '连接监控', '连接监控', '1xw98nknao', 'MENU', '1548901111999770525', 'IFRAME', 'http://localhost:82/druid/index.html', NULL, 'console-sql-outlined', NULL, 'YES', 'YES', 'YES', 25, NULL, 'NOT_DELETE', NULL, NULL, NULL, NULL);
INSERT INTO `SYS_RESOURCE` VALUES ('1548901111999772926', '1548901111999772126', '接口文档', 'jieKouWenDang', 'ookzmx37dt', 'MENU', '1548901111999770525', 'IFRAME', 'http://localhost:82/doc.html', NULL, 'file-word-outlined', NULL, 'YES', 'YES', 'YES', 26, NULL, 'NOT_DELETE', NULL, NULL, NULL, NULL);
