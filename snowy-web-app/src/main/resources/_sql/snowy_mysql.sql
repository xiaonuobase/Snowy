...
INSERT INTO `DEV_CONFIG` VALUES ('1908870094824755301', 'SNOWY_FILE_RUSTFS_ACCESS_KEY', 'RUSTFS文件AccesKey', 'RUSTFS', 'RUSTFS文件AccesKey', 184, NULL, 'NOT_DELETE', NULL, NULL, NULL, NULL);
INSERT INTO `DEV_CONFIG` VALUES ('1908870094824755302', 'SNOWY_FILE_RUSTFS_SECRET_KEY', 'RUSTFS文件SecetKey', 'RUSTFS', 'RUSTFS文件SecetKey', 185, NULL, 'NOT_DELETE', NULL, NULL, NULL, NULL);
INSERT INTO `DEV_CONFIG` VALUES ('1908870094824755303', 'SNOWY_FILE_RUSTFS_END_POINT', 'RUSTFS文件EndPoint', 'RUSTFS', 'RUSTFS文件EndPoint', 186, NULL, 'NOT_DELETE', NULL, NULL, NULL, NULL);
INSERT INTO `DEV_CONFIG` VALUES ('1908870094824755304', 'SNOWY_FILE_RUSTFS_DEFAULT_BUCKET_NAME', 'defaultbucket', 'RUSTFS', 'RUSTFS文件默认存储桶', 187, NULL, 'NOT_DELETE', NULL, NULL, NULL, NULL);
INSERT INTO `DEV_CONFIG` VALUES ('1908870094824755304', 'SNOWY_FILE_RUSTFS_REGION', 'us-east-1', 'RUSTFS', 'RUSTFS文件区域', 188, NULL, 'NOT_DELETE', NULL, NULL, NULL, NULL);
