 ...
 **/
@Slf4j
public record AuthSamlCommonClient(AuthSamlBaseJson authSamlBaseJson) {

    public AuthBaseRequest getAuthRequest() {
        return new AuthSamlCommonRequest(authSamlBaseJson);
    }
}
